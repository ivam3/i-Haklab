...
$(which sh) -c 'ssh -o StrictHostKeyChecking=no -o ServerAliveInterval=60 -R 80:localhost:'$port' localhost.run 2> /dev/null > sendlink ' &
printf "\n"
sleep 2
...
echo ""
	...
	ln -s $PREFIX/bin/ngrok $PWD/ngrok 2> /dev/null
else
...
printf "\n"
printf "\e[1;92m[\e[0m\e[1;77m01\e[0m\e[1;92m]\e[0m\e[1;93m Localhost.run (SSH Tunneling, Best!)\e[0m\n"
